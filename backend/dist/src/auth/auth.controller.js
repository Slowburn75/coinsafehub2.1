...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns JWT access token and refresh token' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid credentials or account suspended' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Account created. Verification email sent.' }),
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Verify email with 6-digit OTP' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Email verified. Returns access token for auto-login.' }),
...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.Patch)('set_password'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Set new password using uidb64 and token from reset email' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Validation error or wrong current password' }),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Post)('update_pin'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update 4-digit security PIN' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'PIN updated' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('sub')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_pin_dto_1.UpdatePinDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "updatePin", null);
